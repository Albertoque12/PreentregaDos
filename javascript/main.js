...
document.getElementById("pagar").onclick = function () {pagoExitoso()}

function pagoExitoso() {
  document.getElementById("pagado").innerHTML = "Su pago se ha realizado de manera exitosa"

}



// AGREGANDO JSON Y STORAGE
// AGREGANDO JSON Y STORAGE
// AGREGANDO JSON Y STORAGE
// AGREGANDO JSON Y STORAGE
// AGREGANDO JSON Y STORAGE
...
let caja = document.querySelector(".product")

let cajasinfi = ""

for(producto of productos){
  cajasinfi += `
  <div class="productFormato">
            <p> ${producto.nombre} </p>
            <div> <img class="added img" src="./img/carrito-de-compras.png" alt=""> </div>
            <button type="button" class="boton">Agregar al carrito</button>
        </div>
`
}
caja.innerHTML += cajasinfi




document.getElementById("identificadorImg").classList.remove("added")
